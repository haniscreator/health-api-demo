...
* **CP Use**: Used to map patient demographics (HNO, Name, Date of Birth, Gender, Address, Phone No.).
...
* **CP Use**: Used to map the patient's drug allergy (e.g., Penicillin) separately from the core demographic patient resource.
...
* **CP Use**: Represents clinic bookings, checkups, or online consultations.
...
* **CP Use**: Represents clinical staff, therapists, or doctors responsible for treating the patient.
...
* **CP Use**: Used in scheduling systems to manage future checkups before they become active Encounters.
...
* **CP Use**: Captures patient vitals (e.g., blood pressure, weight, heart rate) or laboratory tests.
...
* **CP Use**: Represents diagnoses mapped from the ICD database integration.
...
* **CP Use**: Represents prescriptions given during checkups.
